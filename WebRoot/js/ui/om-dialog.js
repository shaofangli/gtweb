/*
 * $Id: om-dialog.js,v 1.28 2012/03/15 07:16:12 wangfan Exp $
...
$.omWidget("om.omDialog", {
     ...
     * @function
     * @example
     * var isOpen = $("#select").omDialog('setBtnTxt');
     * 
     */
	setBtnTxt:function(btnindex,str){
		$("button[class='om-btn-txt']","div[aria-labelledby='ui-dialog-title-"+this.element.attr("id")+"']")[btnindex].innerHTML=str;
	},
	/**by lsf
     * 修改对话框里的按钮状态是否可点击
     * @btnindex 按钮的索引值从0开始
     * @bol true 不可点击 or false 可点击
     * @function
     * @example
     * var isOpen = $("#select").omDialog('setBtnEnable',0,false);
     * 
     */
	setBtnEnable:function(btnindex,bol){
		$("button[class='om-btn-txt']","div[aria-labelledby='ui-dialog-title-"+this.element.attr("id")+"']")[btnindex].disabled=bol;
	},
