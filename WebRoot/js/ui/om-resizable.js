/*
 * $Id: om-resizable.js,v 1.3 2012/03/15 06:14:47 linxiaomin Exp $
...
$.omWidget("om.resizable", $.om.mouse, {
	...
	_mouseStop: function(event) {
		...
		if(this._helper) {
			var pr = this._proportionallyResizeElements, ista = pr.length && (/textarea/i).test(pr[0].nodeName),
				soffseth = ista && $.om.hasScroll(pr[0], 'left') /* TODO - jump height */ ? 0 : self.sizeDiff.height,
...
$.om.plugin.add("resizable", "alsoResize", {
...
$.om.plugin.add("resizable", "animate", {
...
$.om.plugin.add("resizable", "containment", {
	...
	start: function(event, ui) {
		...
		// i'm a node, so compute top, left, right, bottom
			...
			var co = self.containerOffset, ch = self.containerSize.height,	cw = self.containerSize.width,
						width = ($.om.hasScroll(ce, "left") ? ce.scrollWidth : cw ), height = ($.om.hasScroll(ce) ? ce.scrollHeight : ch);
